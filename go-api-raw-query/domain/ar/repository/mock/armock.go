...
func (m *MockArRepository) CreateData(ctx context.Context, request model.AR) (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArRepositoryMockRecorder) CreateData(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateData", reflect.TypeOf((*MockArRepository)(nil).CreateData), ctx, request)
}

// CreateDataDetail mocks base method.
func (m *MockArRepository) CreateDataDetail(ctx context.Context, request model.ARDetail) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateDataDetail", ctx, request)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateDataDetail indicates an expected call of CreateDataDetail.
func (mr *MockArRepositoryMockRecorder) CreateDataDetail(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateDataDetail", reflect.TypeOf((*MockArRepository)(nil).CreateDataDetail), ctx, request)
}
...
func (m *MockArRepository) GetOneData(ctx context.Context, arID int64) (model.ARResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOneData", ctx, arID)
	ret0, _ := ret[0].(model.ARResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetOneDataSales mocks base method.
func (m *MockArRepository) GetOneDataSales(ctx context.Context, salesID int64) (model.ARSales, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOneDataSales", ctx, salesID)
	ret0, _ := ret[0].(model.ARSales)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetOneDataSales indicates an expected call of GetOneDataSales.
func (mr *MockArRepositoryMockRecorder) GetOneDataSales(ctx, salesID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOneDataSales", reflect.TypeOf((*MockArRepository)(nil).GetOneDataSales), ctx, salesID)
}
